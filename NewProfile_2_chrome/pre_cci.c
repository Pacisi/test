# 1 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c"
...
# 1 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c" 2
...
# 2 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"6701d4a1542a49009c4ffd8a6528fa53\",\"statu"
...
# 3 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c" 2
...
# 4 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c" 2
...
lr_start_transaction("02_NewProfile");
	...
	web_submit_data("newProfile.pl", 
		...
		"LAST");
lr_end_transaction("02_NewProfile",2);
...
lr_start_transaction("03_Enter");
	...
	web_submit_data("newProfile.pl_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=USER", "Value=testuser{nr}", "ENDITEM", 
		"Name=PASSWORD", "Value=testuser{nr}", "ENDITEM", 
		"Name=FIRSTNAME", "Value=testuser{nr}", "ENDITEM", 
		"Name=LASTNAME", "Value=testuser{nr}", "ENDITEM", 
		"Name=STREET", "Value=testuser{nr}", "ENDITEM", 
		"Name=CITY", "Value=testuser{nr}", "ENDITEM", 
		"Name=COUNTRY", "Value=testuser{nr}", "ENDITEM", 
...
# 5 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c" 2
...
# 6 "c:\\arbeit lokal\\schulungen\\ldbv\\lr-l\366sungen\\lr-l\366sungen\\\374bung_6\\newprofile_2_chrome\\\\combined_NewProfile_2_chrome.c" 2
